    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="{{ route('home')}}" class="text-decoration-none">
                ...
                <!-- <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Hà</span> -->
            </a>
        </div>
        <div class="col-lg-4 col-6 text-left">
            <form action="index.php?pg=product" method="post">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Tìm Kiếm sản phẩm" name="kyw" id="">
                    <input type="submit" class="input-group-text bg-transparent text-primary" name="timkiem"></input>
                </div>
            </form>
        </div>
        <div class="col-lg-4 col-6 text-right">
            ...
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="bg-transparent text-primary">Logout</button>
            </form>
            @else
            <p>Xin chào, khách!</p>
            @endif
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{ route('product')}}" class="nav-item nav-link active">Sản phẩm</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                            <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                <a href="cart.php?pg=cart" class="dropdown-item">Shopping Cart</a>
